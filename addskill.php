...
<html lang="en">
  ...
  include "config.php";
    if(isset($_POST['addad'])){
        ...
        $sql="INSERT INTO skills(namesk, percent) VALUES('$name','$mota')";
        ...
        <div class="row">
            ...
            <a class="btn btn-success" href="admin-about.php"><i class="fas fa-undo"></i> Trở lại</a>
                <div class="card mt-5">
                    ...
                    <h1 class ="text-center py-3"> Thêm kỹ năng</h1>
                    </div>
                    <form action="" method="POST">
                         <div class="">
                            <label class="font-weight-bold" for="">Tên kỹ năng</label>
                            <input type="text" name="tencv" class="form-control" >
                        </div>
                        <div class="form-group">
                            <label class="font-weight-bold" for="">Độ hiểu biết (%)</label>
